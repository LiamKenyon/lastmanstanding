...
async function getData() {
  const res = await fetch("http://localhost:3000/api/month-fixtures");
  return res.json();
}
        ...
        {data.map(({ date, games }) => (
          <div key={date} className="date-fixture-container">
            ...
            {games.map((game, index) => (
              ...
              >
                <div className="home-team font-bold">
                  <TeamSelectButton team={game.homeNameAbbrv} />
                </div>
                <img
                  className="team-img"
                ...
                <img
                  ...
                  alt=""
                />
                <div className="away-team font-bold">
                  <TeamSelectButton team={game.awayNameAbbrv} date={game.date} />
                </div>
